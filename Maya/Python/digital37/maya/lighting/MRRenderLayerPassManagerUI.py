...
#
# Created: Fri Jan 20 18:19:21 2012
...
class Ui_root(object):
    def setupUi(self, root):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 0, 1111, 671))
        ...
        self.label_RL.setText(QtGui.QApplication.translate("root", "Scene Render Layers:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_RL.setObjectName(_fromUtf8("label_RL"))
        self.verticalLayout_7.addWidget(self.label_RL)
        self.listWidget_SL = QtGui.QListWidget(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.listWidget_SL)
        self.pushButton_SL_add = QtGui.QPushButton(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.pushButton_SL_add)
        self.pushButton_SL_remove = QtGui.QPushButton(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.pushButton_SL_remove)
        self.line_5 = QtGui.QFrame(self.widget)
        self.line_5.setFrameShape(QtGui.QFrame.HLine)
        self.line_5.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_5.setObjectName(_fromUtf8("line_5"))
        self.verticalLayout_7.addWidget(self.line_5)
        self.label_RL_2 = QtGui.QLabel(self.widget)
        self.label_RL_2.setText(QtGui.QApplication.translate("root", "Create Render Layers:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_RL_2.setObjectName(_fromUtf8("label_RL_2"))
        self.verticalLayout_7.addWidget(self.label_RL_2)
        self.listWidget_CL = QtGui.QListWidget(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.listWidget_CL)
        self.verticalLayout_9 = QtGui.QVBoxLayout()
        self.verticalLayout_9.setObjectName(_fromUtf8("verticalLayout_9"))
        self.verticalLayout_7.addLayout(self.verticalLayout_9)
        self.pushButton_CL_add = QtGui.QPushButton(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.pushButton_CL_add)
        self.pushButton_CL_remove = QtGui.QPushButton(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.pushButton_CL_remove)
        self.pushButton_CL_apply = QtGui.QPushButton(self.widget)
        ...
        self.verticalLayout_7.addWidget(self.pushButton_CL_apply)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 1111, 18))
