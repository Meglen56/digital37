...
//Name: mrLayerPass.ma
//Last modified: Fri, Dec 16, 2011 06:26:59 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.4885792150900157 3.2165537120581922 3.8509793880680241 ;
	setAttr ".r" -type "double3" -24.938352729603764 53.400000000000631 -5.3344884036362716e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5.0920216984351994;
...
createNode transform -n "pPlane1";
	setAttr ".s" -type "double3" 12.632746243723147 12.632746243723147 12.632746243723147 ;
...
createNode transform -n "spotLight1";
	setAttr ".t" -type "double3" -5.386602978155735 12.738555188251413 10.565449530553837 ;
	setAttr ".r" -type "double3" -46.200000000000429 -26.400000000000109 -1.7754342538795053e-015 ;
createNode spotLight -n "spotLightShape1" -p "spotLight1";
	setAttr -k off ".v";
	setAttr ".col" 21.853786268077471;
createNode transform -n "camera2";
	setAttr ".t" -type "double3" 0.096618427678573926 1.325854703744348 4.8059631107460516 ;
	setAttr ".r" -type "double3" -8.3999999999999986 0.80000000000000027 -1.2425252888301797e-017 ;
createNode camera -n "cameraShape2" -p "camera2";
	setAttr -k off ".v";
	setAttr ".cap" -type "double2" 1.41732 0.94488 ;
	setAttr ".ff" 0;
	setAttr ".coi" 9.8948418143483696;
	setAttr ".ow" 30;
...
createNode transform -n "nurbsSphere1";
	setAttr ".t" -type "double3" -2.4893454813847082 0 -3.1926222231460835 ;
createNode nurbsSurface -n "nurbsSphereShape1" -p "nurbsSphere1";
	...
	setAttr ".nufa" 4.5;
	setAttr ".nvfa" 4.5;
createNode transform -n "subdivCube1";
	setAttr ".t" -type "double3" 2.5271883572674865 0 -2.8749115210107816 ;
createNode subdiv -n "subdivCube1Shape" -p "subdivCube1";
	addAttr -ci true -sn "mso" -ln "miShadingSamplesOverride" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "msh" -ln "miShadingSamples" -min 0 -smx 8 -at "float";
	addAttr -ci true -sn "mdo" -ln "miMaxDisplaceOverride" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "mmd" -ln "miMaxDisplace" -min 0 -smx 1 -at "float";
...
createNode partition -n "mtorPartition";
	...
	setAttr ".sd" -type "string" "#\n# generated by slim for majun at Wed Dec 14 13:20:37 China Standard Time 2011\n#\nslim 2 TOR slim {\n}\n";
...
connectAttr "mia_exposure_simple1.msg" "cameraShape2.mils";
...
connectAttr "subdivCube1Shape.iog" ":initialShadingGroup.dsm" -na;
